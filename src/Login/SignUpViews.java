...
public class SignUpViews extends javax.swing.JFrame { 
    ...
    private void initComponents() { 
        ...
        textfMail.addActionListener(evt -> textfMailActionPerformed(evt)); 
        jLabel3.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N 
        jLabel3.setText("Confirm Password"); 
        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N 
        jLabel4.setText("Mail"); 
        textfUserName.addActionListener(evt -> textfUserNameActionPerformed(evt)); 
        ...
        textfpassword.addActionListener(evt -> textfpasswordActionPerformed(evt)); 
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed 
        // button register: 
        var password = textfpassword.getText(); 
        var confirmpassword = textfcomfirmpassword.getText(); 
        var username = textfUserName.getText(); 
        var mail = textfMail.getText(); 
        if (password.equals(confirmpassword) && !username.isEmpty()) { 
            password = Utilyti.getSecurityMD5(password); 
            var us = new Users(username, mail, password, 2); 
            try { 
                ...
                java.util.logging.Logger.getLogger(SignUpViews.class.getName()).log(java.util.logging.Level.SEVERE, null, e); 
            } 
    ...
    public static void main(String args[]) { 
        ...
        java.awt.EventQueue.invokeLater(() -> new SignUpViews().setVisible(true)); 
    } 
